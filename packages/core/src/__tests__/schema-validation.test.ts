...
describe('conditionally required fields', () => {
  ...
  describe('should validate multiple conditional requirements on different fields', () => {
    ...
    it('should validate when two fields depend on each other', async () => {
      mockActionFields['a'] = {
        label: 'a',
        type: 'string',
        required: {
          conditions: [{ fieldKey: 'b', operator: 'is', value: undefined }]
        },
        description: 'a'
      }
      ...
      const b_required_mappings = [{ a: 'a_value' }, { a: 'a_value', b: 'b_value' }]
      const a_required_mappings = [{ b: 'b_value' }, { a: 'a_value', b: 'b_value' }]
      const both_required = {}
      ...
      isValid = validateSchema(a_required_mappings[0], schema, { throwIfInvalid: false })
      expect(isValid).toBe(true)

      isValid = validateSchema(a_required_mappings[1], schema, { throwIfInvalid: false })
      expect(isValid).toBe(true)
  ...
  describe('should handle object conditions', () => {
    ...
    it('should validate multiple object conditions where multiple objects are referenced', async () => {
      mockActionFields['a'] = {
        type: 'object',
        label: 'a',
        description: 'a',
      ...
      mockActionFields['e'] = {
        ...
        description: 'e',
        required: {
          // e is required when a.b is 'b_value' and c.d is 'd_value'
          conditions: [
            { fieldKey: 'a.b', operator: 'is', value: 'b_value' },
            { fieldKey: 'c.d', operator: 'is', value: 'd_value' }
          ]
        }
      }
      ...
      const e_required_mappings = [
        ...
        { a: { b: 'b_value' }, c: { d: 'd_value' }, e: 'e_value' }
      ]

      const e_not_required_mappings = [
        { a: { b: 'b_value' }, c: { d: 'not d_value' } },
        { a: { b: 'not b_value' }, c: { d: 'd_value' } },
        { a: { b: 'not b_value' }, c: { d: 'not d_value' } },
        { a: { b: 'b_value' }, e: 'e_value' }
      ]
  ...
  describe('should handle different data types', () => {
    ...
    it('should validate when multiple values of a condition are undefined', async () => {
      mockActionFields['a'] = {
        type: 'string',
        label: 'a',
        description: 'a'
      ...
      mockActionFields['c'] = {
        ...
        required: {
          conditions: [
            // if a and b are undefined, c is required
            { fieldKey: 'a', operator: 'is', value: undefined },
            { fieldKey: 'b', operator: 'is', value: undefined }
          ]
        }
      }
      ...
      const b_required_mappings = [
        ...
        { a: undefined, c: 'c_value' },
        { a: undefined, b: undefined, c: 'c_value' }
      ]
      const b_not_required_mappings = [{ a: 'a_value' }, { a: 'a_value', b: 'b_value' }, { a: 'a_value', c: 'c_value' }]
    ...
    it('should validate when multiple values of a condition are undefined, any matcher', async () => {
      mockActionFields['a'] = {
        type: 'string',
        label: 'a',
        description: 'a'
      ...
      mockActionFields['c'] = {
        ...
        required: {
          match: 'any',
          conditions: [
            // if a or b are undefined, c is required
            { fieldKey: 'a', operator: 'is', value: undefined },
            { fieldKey: 'b', operator: 'is', value: undefined }
          ]
        }
      ...
      const b_required_mappings = [
        ...
        { a: undefined, c: 'c_value' },
        { a: undefined, b: undefined, c: 'c_value' },
        { b: undefined, c: 'c_value' }
      ]
      const b_not_required_mappings = [
        { a: 'a_value', b: 'b_value' },
        { a: 'a_value', b: 'b_value', c: 'c_value' }
      ]
      ...
      isValid = validateSchema(b_required_mappings[4], schema, { throwIfInvalid: false })
      expect(isValid).toBe(true)

      isValid = validateSchema(b_required_mappings[5], schema, { throwIfInvalid: false })
      expect(isValid).toBe(true)
  ...
  // TODO: support sync mode conditions
