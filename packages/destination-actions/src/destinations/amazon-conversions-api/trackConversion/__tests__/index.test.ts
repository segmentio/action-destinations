...
describe('trackConversion', () => {
  ...
  describe('perform', () => {
    it('should send event data successfully', async () => {
      nock(`${Region.NA}`).post('/adsApi/v1/create/events').reply(200, { success: true })
    ...
    it('should handle API errors', async () => {
      ...
      nock(`${Region.NA}`).post('/adsApi/v1/create/events').replyWithError('Invalid event data')
  ...
  describe('performBatch', () => {
    ...
    it('should handle API errors in batch mode', async () => {
      nock(`${Region.NA}`).post('/adsApi/v1/create/events').reply(500, { error: 'Internal server error' })
