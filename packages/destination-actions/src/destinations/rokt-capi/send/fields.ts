...
export const fields: Record<string, InputField> = {
    eventDetails: {
        ...
        properties: {
            conversiontype: {
                ...
                description: 'Type of conversion, This should usually be mapped to the Segment track() event name. e.g., "Order Completed".',
                type: 'string'
            },
            confirmationref: {
    ...
    user_identities: {
        ...
        description: 'Unique user identifiers used to identify the user. At least one identifier is required, or the advertising ID in device info.',
        type: 'object',
        required: false,
        properties: {
            email: {
    ...
    engageFields: {
        label: 'Properties or Traits object',
        description: 'Hidden field used figure out audience membership when syncing an Engage Audience.',
        type: 'object',
        unsafe_hidden: true,
        properties: {
            engageAudienceName: {
        ...
        default: { 
            audiencename: { '@path': '$.context.personas.audience_key' },
            traitsOrProps: {
                '@if': {
