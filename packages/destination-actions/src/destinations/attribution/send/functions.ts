...
export function send(request: RequestClient, payload: Payload) {
  ...
  if (type === 'track') {
    ...
    return sendJSON(request, trackJSON)
    ...
    return sendJSON(request, pageOrScreenJSON)
    ...
    return sendJSON(request, identifyJSON)
  } else if (type === 'group') {
    ...
    return sendJSON(request, groupJSON)
  } else if (type === 'alias') {
    ...
    return sendJSON(request, aliasJSON)
  }
}
