...
const destination: DestinationDefinition<Settings> = {
  ...
  authentication: {
    ...
    fields: {
      ...
      accountID: {
        label: 'Account ID',
        description: `You can find your Account ID (piAId) under Marketing > Campaigns in your Pardot account. After selecting your desired website campaign, press View Tracking Code. `,
        type: 'string',
        required: true
      },
      isSandbox: {
