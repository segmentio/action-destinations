...
export interface Settings {
  ...
  /**
   * You can find your Account ID (piAId) under Marketing > Campaigns in your Pardot account. After selecting your desired website campaign, press View Tracking Code.
   */
  accountID: string
  /**
