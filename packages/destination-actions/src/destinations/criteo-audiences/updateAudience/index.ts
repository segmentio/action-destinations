...
//Criteo API variables
//const authEndpoint = 'http://api.criteo.com/oauth2/token';
//const manageUsersEndpoint = `https://api.criteo.com/2021-01/audiences/${audienceId}/contactlist`;
//const getAudienceEndpoint = `https://api.criteo.com/2021-10/audiences?advertiser-id=${advertiserId}`;

//let authToken = '';

const action: ActionDefinition<Settings, Payload> = {
  title: 'Update Audience',
  description: 'Add/remove users from Criteo audience by connecting to Criteo API',
  defaultSubscription: 'type = "track" and (event = "Audience Entered" or event = "Audience Exited")',
  fields: {
