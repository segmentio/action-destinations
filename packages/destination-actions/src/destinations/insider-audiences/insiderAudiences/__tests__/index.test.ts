...
describe('InsiderAudiences.insiderAudiences', () => {
  ...
  it('should insert user attributes when computation class is audience and type is identify', async () => {
    nock('https://unification.useinsider.com/api').post('/user/v1/upsert').reply(200, {})
  ...
  it('should insert event when computation class is audience and type is track', async () => {
    nock('https://unification.useinsider.com/api').post('/user/v1/upsert').reply(200, {})
