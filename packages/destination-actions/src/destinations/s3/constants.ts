...
// Caches STS assume-role credentials until shortly before their reported expiry, cutting STS
// call volume on high-volume audience syncs. Off by default for a gradual, safe rollout after
// STRATCONN-6986 / INC 20659.
