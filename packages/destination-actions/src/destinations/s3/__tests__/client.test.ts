...
import { Client, clearCredentialsCache, isAWSError, buildTimestampedFilename } from '../syncToS3/client'
import { S3Client, _Error as AWSError } from '@aws-sdk/client-s3'
import { Settings } from '../generated-types'
import { S3_FILENAME_FIX_FLAG, S3_STS_CREDENTIAL_CACHE_FLAG } from '../constants'
import { CREDENTIALS_EXPIRY_BUFFER_MS } from '../syncToS3/constants'

// Controllable mocks so the filename-fix-flag tests can inspect the S3 key that gets PUT, and the
// caching tests can control credential responses.
