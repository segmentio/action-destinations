import { AudienceDestinationDefinition, InvalidAuthenticationError, ErrorCodes } from '@segment/actions-core'
import type { Settings } from './generated-types'
import syncAudiences from './syncAudiences'
import { GetAudienceResponse, RefreshTokenResponse } from './types'
import { BASE_URL, TOKEN_URL } from './constants'
import { createBingAudience } from './utils'
...
const destination: AudienceDestinationDefinition<Settings> = {
  ...
  audienceConfig: {
    ...
    createAudience: async (request, createAudienceInput) => {
      ...
      const audienceId = await createBingAudience(request, createAudienceInput?.audienceName)
