 ...
 */
export const FACEBOOK_CONVERSIONS_API_VERSION = '26.0'

/** FACEBOOK_CONVERSIONS_CANARY_API_VERSION
 * Facebook Conversions API canary version.
 * API reference: https://developers.facebook.com/docs/marketing-api/overview/versioning
 * Testing v26.0 behind the 'facebook-capi-actions-canary-version' feature flag. v24.0 is sunset by Meta on 2026-10-06.
 */
export const FACEBOOK_CONVERSIONS_CANARY_API_VERSION = '26.0'
