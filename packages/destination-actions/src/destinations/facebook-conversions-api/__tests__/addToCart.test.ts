...
describe('FacebookConversionsApi', () => {
  describe('AddToCart', () => {
    ...
    describe('with refactored code path (feature flag enabled)', () => {
        ...
        const responses = await testDestination.testAction('addToCart', {
          ...
          mapping: {
            ...
            user_data: {
              ...
              partner_id: { '@path': '$.properties.partner_id' },
              partner_name: { '@path': '$.properties.partner_name' }
            },
            action_source: { '@path': '$.properties.action_source' },
            event_time: { '@path': '$.timestamp' },
            custom_data: { '@path': '$.properties.traits' }
          }
        })
        ...
        await expect(
          testDestination.testAction('addToCart', {
            ...
            mapping: {
              currency: { '@path': '$.properties.currency' },
              value: { '@path': '$.properties.value' },
              user_data: { email: { '@path': '$.properties.email' } },
              action_source: { '@path': '$.properties.action_source' },
              event_time: { '@path': '$.timestamp' }
            }
          })
      ...
      it('should send data processing options', async () => {
        ...
        const responses = await testDestination.testAction('addToCart', {
          ...
          mapping: {
            action_source: { '@path': '$.properties.action_source' },
            data_processing_options: { '@path': '$.properties.data_processing_options' },
            data_processing_options_state: { '@path': '$.properties.data_processing_options_state' },
            data_processing_options_country: { '@path': '$.properties.data_processing_options_country' }
          }
        })
      ...
      it('should send test_event_code if present in the mapping', async () => {
        ...
        const responses = await testDestination.testAction('addToCart', {
          ...
          mapping: {
            ...
            event_time: { '@path': '$.timestamp' },
            custom_data: { '@path': '$.properties.traits' },
            test_event_code: { '@path': '$.properties.test_event_code' }
          }
        })
      ...
      it('should handle basic event with multiple externalIds', async () => {
        ...
        const responses = await testDestination.testAction('addToCart', {
          ...
          mapping: {
            ...
            value: { '@path': '$.properties.value' },
            user_data: {
              externalId: { '@path': '$.properties.externalIds' },
              email: { '@path': '$.properties.email' },
              partner_id: { '@path': '$.properties.partner_id' },
              partner_name: { '@path': '$.properties.partner_name' }
            },
