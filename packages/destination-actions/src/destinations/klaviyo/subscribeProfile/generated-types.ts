...
export interface Payload {
  /**
   * The unique userId of the profile in Klaviyo. If provided, this will be used to perform the profile lookup. One of email or phone number is still required.
   */
  klaviyo_id?: string
  /**
