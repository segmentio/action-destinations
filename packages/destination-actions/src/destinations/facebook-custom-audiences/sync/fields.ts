...
export const fields: Record<string, InputField> = {
  ...
  traits_or_properties: {
    ...
    description: 'Hidden field to used for processing an Engage Audience.',
    type: 'object',
    unsafe_hidden: true,
    default: {
      '@if': {
  ...
  computation_class: {
    ...
    description: "Hidden field used to check if the payload is generated by an Engage Audience. values with 'audience' or 'journey_step' indicate an Engage audience.",
    type: 'string',
    unsafe_hidden: true,
    default: {
