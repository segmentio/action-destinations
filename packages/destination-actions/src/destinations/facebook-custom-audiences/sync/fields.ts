...
export const fields: Record<string, InputField> = {
  ...
  membership_fields: {
    ...
    description: 'Field used for determining if the user should be added to or removed from the Audience. For use with Engage Audiences or when syncing from Reverse ETL.',
    type: 'object',
    required: false,
    unsafe_hidden: true,
    properties: {
      ...
      retl_event_name: {
        label: 'Reverse ETL Membership',
        description: 'If set to "new" or "updated" the user will be added to the Audience. If set to "deleted" the user will be removed from the Audience',
        type: 'string',
        required: false
      }
    }, 
