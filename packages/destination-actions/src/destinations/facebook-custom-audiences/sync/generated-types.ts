...
export interface Payload {
  ...
  batch_size: number
  /**
   * Field used for determining if the user should be added to or removed from the Audience. For use with Engage Audiences or when syncing from Reverse ETL.
   */
  membership_fields?: {
    /**
     * Field used for processing an Engage Audience.
     */
    ...
    /**
     * If set to "new" or "updated" the user will be added to the Audience. If set to "deleted" the user will be removed from the Audience
     */
    retl_event_name?: string
  }
}
// Generated file. DO NOT MODIFY IT BY HAND.
