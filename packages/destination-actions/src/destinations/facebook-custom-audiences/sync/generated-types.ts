...
export interface Payload {
  ...
  batch_size: number
  /**
   * Hidden field to used for processing an Engage Audience.
   */
  ...
  audience_key?: string
  /**
   * Hidden field used to check if the payload is generated by an Engage Audience. values with 'audience' or 'journey_step' indicate an Engage audience.
   */
