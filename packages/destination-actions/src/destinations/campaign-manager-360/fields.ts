...
export const commonFields: ActionDefinition<Settings>['fields'] = {
    ...
    requiredId: {
      label: 'Required ID',
      description: 'A user identifier record the conversion against. Exactly one of Google Click ID, Display Click ID, Encrypted User ID, Mobile Device ID, Match ID or Impression ID must be provided.',
      type: 'object',
      required: true,
      properties: {
        gclid: {
