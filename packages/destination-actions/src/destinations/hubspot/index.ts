...
const destination: DestinationDefinition<Settings> = {
  ...
  extendRequest({ auth }) {
    return {
      ...
      headers: {
        authorization: `Bearer CO_SvsfzMRIVAAEBQAAA4QIAAAC4AAAAAAAQAAACGJr1gwsgosxAKJf4QTIUwhE7qnzEH-ZdMp--cd-UsyjSMUs6QAAAAEEAAAAAwAcAAAAAAAAAgAAAAAAAAAAMACAAjgA-AOABAAAAAAAA_GcAAADwAwAAAAAAAABAAAAAAAAEAAxCFJI6wfw2KPKu7kkdLVOMYvlGwPPASgNuYTFSAFoAYAA`
      }
    }
  },
