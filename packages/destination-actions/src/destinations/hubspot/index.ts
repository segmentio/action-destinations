...
const destination: DestinationDefinition<Settings> = {
  ...
  extendRequest({ auth }) {
    return {
      ...
      headers: {
        authorization: `Bearer CMbwz8XzMRIVAAEBQAAA4QIAAAC4AAAAAAAQAAACGJr1gwsgosxAKJf4QTIUUPV2hOYBhrsIs_ZBe7B7R-f6C4Q6QAAAAEEAAAAAwAcAAAAAAAAAgAAAAAAAAAAMACAAjgA-AOABAAAAAAAA_GcAAADwAwAAAAAAAABAAAAAAAAEAAxCFAHqDXcfVpxf0uNZeQt_cq16k54ASgNuYTFSAFoAYAA`
      }
    }
  },
