...
const destination: DestinationDefinition<Settings> = {
  ...
  extendRequest() {
    return {
      ...
      headers: {
        authorization: `Bearer CMLFmvnqMRIVAAEBQAAA4QIAAAC4AAAAAAAQAAACGJr1gwsgosxAKJf4QTIUNT6X_w38gOF8nUA6Q6_y7TU8apM6QAAAAEEAAAAAwAcAAAAAAAAAgAAAAAAAAAAMACAAjgA-AOABAAAAAAAA_GcAAADwAwAAAAAAAABAAAAAAAAEAAxCFEYd4Lw2Cmkytl57oxGDC2FGLaFnSgNuYTFSAFoAYAA`
      }
    }
  },
