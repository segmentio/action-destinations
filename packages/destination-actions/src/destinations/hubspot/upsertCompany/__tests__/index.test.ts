...
describe('HubSpot.upsertCompany', () => {
  ...
  it('should trim spring properties', async () => {
    const event = createTestEvent({
      type: 'group',
      traits: {
        name: 'Test Company',
        website: 'test-company.com',
        city: '  San Francisco  ', // should be trimmed
        customPropertyOne: [1, 2, 3, 4, 5],
        customPropertyTwo: {
          a: 1,
          b: 2,
        ...
        customPropertyThree: [1, 'two', true, { four: 4 }],
        customPropertyFour: '  test  ' // should be trimmed
      },
      groupId: 'test-group-id'
    })
    ...
    const responses = await testDestination.testAction('upsertCompany', {
      ...
      mapping: {
        ...
        properties: {
          ...
          custom_property_4: {
            '@path': '$.traits.customPropertyFour'
          },
          city: {
            '@path': '$.traits.city'
          }
