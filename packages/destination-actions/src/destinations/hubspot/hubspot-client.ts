...
class HubspotClient {
    ...
    async getContactIdentifierTypes(): Promise<DynamicFieldResponse> {
        const contactFields: ContactsFieldsResponse = await this._request(`${HUBSPOT_BASE_URL}/crm/v3/properties/contacts`, {
            method: 'GET',
