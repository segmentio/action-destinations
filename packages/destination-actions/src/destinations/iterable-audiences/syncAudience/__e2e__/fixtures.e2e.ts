...
const fixtures: E2EFixture[] = [
  ...
  },
  {
    ...
    expect: {
      status: 'success',
      jsonContains: [
        { status: 200, sent: { email: 'e2e-aud-test-002@segment.com', userId: 'e2e-iterable-aud-user-002' } },
        { status: 200, sent: { email: 'e2e-aud-test-003@segment.com', userId: 'e2e-iterable-aud-user-003' } },
        { status: 200, sent: { email: 'e2e-aud-test-001@segment.com', userId: 'e2e-iterable-aud-user-001' } }
      ]
    },
    verboseFailureHint: FAILURE_HINT
  }
