...
export const sendRequest = async (request: RequestClient, path: string, settings: Settings, body: any, addSecretey: boolean = false) => {
  let requestOptions = {} as RequestOptions;
