...
describe('Encharge.identifyUser', () => {
  test('should handle and transform "identify" event', async () => {
  ...
  test('should handle and transform "identify" event with email in traits', async () => {
    nock(enchargeIngestAPIBase).post(`/v1`).reply(200, {})
  ...
  test('should handle and transform "identify" event with email in context.traits', async () => {
    nock(enchargeIngestAPIBase).post(`/v1`).reply(200, {})
