...
import { movable_ink_url, user_id, anonymous_id, timestamp, timezone, product, categories_required_false, meta } from '../fields'
  ...
  perform: (request, { settings, payload }) => { 
    ...
    return request(url, {
      ...
      json: {
        ...
        metadata:  { ...omit(payload.meta, ['product', 'categories_required_false'])},
      }
    })
  }
}
