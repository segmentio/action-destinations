...
import { movable_ink_url, event_name, user_id, anonymous_id, timestamp, timezone, products_required_false, order_id_required_false, revenue_required_false, categories_required_false, meta } from '../fields'
  ...
  perform: (request, { settings, payload }) => { 
    ...
    return request(url, {
      ...
      json: {
        ...
        metadata:  { ...omit(payload.meta, ['products_required_false', 'categories_required_false','order_id_required_false', 'revenue_required_false'])}
      }
    })
  }
}
