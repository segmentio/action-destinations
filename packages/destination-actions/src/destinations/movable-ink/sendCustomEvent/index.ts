...
import { event_name, user_id, anonymous_id, timestamp, timezone, products_required_false, order_id_required_false, revenue_required_false, categories_required_false, meta } from '../fields'
