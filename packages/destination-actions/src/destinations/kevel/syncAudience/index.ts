...
const action: ActionDefinition<Settings, Payload> = {
  title: 'Sync Audience',
  description:
    "Sync a Segment Engage Audience to a Kevel UserDB Interest. Only users with a Segment userId will be synced. KSee Kevel's [documentation for more details](https://dev.kevel.com/reference/add-interest-to-user).",
