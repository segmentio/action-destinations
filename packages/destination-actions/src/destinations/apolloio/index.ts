...
export const baseURL = process?.env?.ACTIONS_APOLLOIO_BASE_URL_SECRET ? `${process.env.ACTIONS_APOLLOIO_BASE_URL_SECRET}` : 'https://apollo.io/'
export const authURL = process?.env?.ACTIONS_APOLLOIO_AUTH_URL_SECRET ? `${process.env.ACTIONS_APOLLOIO_AUTH_URL_SECRET}` : 'https://apollo.io/'
