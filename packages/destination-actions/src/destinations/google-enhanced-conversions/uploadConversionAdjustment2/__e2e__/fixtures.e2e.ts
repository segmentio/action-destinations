...
import uploadConversionAdjustment2 from '../index'
...
const fixtures: E2EFixture[] = [
  {
    ...
    // uploadConversionAdjustments API and is accepted. This action is syncMode-gated (default 'add').
    // adjustment_type is required; order_id and an email identifier give the enhancement something to
    // attach to the original conversion.
    description: 'Uploads a single conversion adjustment with basic information',
    subscribe: 'type = "track"',
    mapping: {
      ...defaultValues(uploadConversionAdjustment2.fields),
    ...
    event: createE2EEvent('track', 'Order Completed', {
      userId: 'e2e-google-adj2-001',
      properties: {
        email: 'e2e-google-adj2-001@segment.com',
