...
describe('GoogleEnhancedConversions', () => {
  describe('uploadClickConversion Single Event', () => {
    ...
    it('sends sessionAttributesKeyValuePairs when provided and sessionAttributesEncoded not provided', async () => {
      ...
      expect(responses[0].options.body).toBe(
        '{"conversions":[{"conversionAction":"customers/1234/conversionActions/12345","conversionDateTime":"2021-06-10 18:08:04+00:00","userIpAddress":"8.8.8.8","sessionAttributesKeyValuePairs":[{"name":"gad_source","value":"Google"},{"name":"gad_campaignid","value":"2142354"},{"name":"landing_page_url","value":"https://segment.com/academy/"},{"name":"session_start_time_usec","value":"1623348484000000"},{"name":"landing_page_user_agent","value":"Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"}],"orderId":"1234","conversionValue":200,"currencyCode":"USD","cartData":{"items":[{"productId":"1234","quantity":3,"unitPrice":10.99}]},"userIdentifiers":[{"hashedEmail":"87924606b4131a8aceeeae8868531fbb9712aaa07a5d3a756b26ce0f5d6ca674"}]}],"partialFailure":true}'
      )
      expect(responses[0].status).toBe(201)
    })
  })
