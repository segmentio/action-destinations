...
describe('GoogleEnhancedConversions', () => {
  describe('uploadClickConversion2 Single Event', () => {
    ...
    it('sends sessionAttributesEncoded when provided', async () => {
      const event = createTestEvent({
        timestamp,
        event: 'Test Event',
        properties: {
      ...
      const responses = await testDestination.testAction('uploadClickConversion2', {
        ...
        mapping: {
          ...
          session_attributes_encoded:
            '',
          __segment_internal_sync_mode: 'add'
        },
        useDefaultMappings: true,
        settings: {
      ...
      expect(responses[0].options.body).toBe(
        '{"conversions":[{"conversionAction":"customers/1234/conversionActions/12345","conversionDateTime":"2021-06-10 18:08:04+00:00","sessionAttributesEncoded":"","orderId":"1234","conversionValue":200,"currencyCode":"USD","cartData":{"items":[{"productId":"1234","quantity":3,"unitPrice":10.99}]},"userIdentifiers":[{"hashedEmail":"87924606b4131a8aceeeae8868531fbb9712aaa07a5d3a756b26ce0f5d6ca674"}]}],"partialFailure":true}'
      )
      expect(responses[0].status).toBe(201)
    })
  })
