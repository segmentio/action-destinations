...
export const PRODUCT_LINK_SEARCH_URL =
  `SELECT product_link.productLower.productLower_customer FROM product_link ` +
  `WHERE product_link.productLower.productLower_customer = 'products/productUpper/customers/advertiserID'`
