...
describe('Send transactional Sms', () => {
  it('should send a message', async () => {
    ...
    nock(settings.api_host).post(`/cpaas/messages`).reply(201, { messageId: '10313448-2ef3-449d-a591-6828c5bec55e' })
  ...
  it('should send a message with a from name or number', async () => {
    // Mock upsertContact  function
    nock(settings.api_host).post(`/cpaas/messages`).reply(201, { messageId: '10313448-2ef3-449d-a591-6828c3bec55e' })
