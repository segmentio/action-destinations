export interface JSONItem {
  profile: {
    ...
    // Customer must select which of the 2 id types below to send. That ID type then becomes required. More than one ID can be sent at a time.
    ref?: string
    email?: string
...
export type TaguchiJSON = JSONItem[]
