export const ACTION_SLUG = 'actions-liveramp-audiences'
...
export const LIVERAMP_ALPHABETICAL_FIELD_ORDER_FLAG_NAME = 'actions-liveramp-audiences-alphabetical-field-order'
