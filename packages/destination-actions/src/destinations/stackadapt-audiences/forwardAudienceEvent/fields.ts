...
export const profile_fields: Record<string, InputField> = {
  ...
  custom_traits: {
    ...
    depends_on: {
      match: 'all',
      conditions: [
        // Show the legacy field for any mode other than the new v2 field (including unset / pre-existing instances).
        { fieldKey: 'custom_properties_mode', operator: 'is_not', value: 'v2' }
      ]
    }
  },
