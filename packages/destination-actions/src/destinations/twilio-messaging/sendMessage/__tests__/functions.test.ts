...
describe('Functions should work correctly', () => {
    describe('getSendAt', () => {
        ...
        it('getSendAt throws error when less than 15 minutes into the future', async () => {
            ...
            expect(() => getSendAt(tenMinutesFromNow)).toThrow(/'Send At' time of .* is invalid\. It must be at least 15 minutes and at most 35 days in the future\./
            )
        })
        ...
        it('getSendAt throws error when more than 35 days into the future', async () => {
            ...
            expect(() => getSendAt(thirtySixDaysFromNow)).toThrow(/'Send At' time of .* is invalid\. It must be at least 15 minutes and at most 35 days in the future\./
            )
        })
    })
