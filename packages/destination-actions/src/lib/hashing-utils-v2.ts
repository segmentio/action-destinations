...
/**
 * Processes the given value by hashing it using the specified encryption method and digest type.
 * If the value is already hashed, it returns the value as is.
 * Optionally, a cleaning function can be applied to the value before hashing.
 *
 * @param value - The string value to be hashed.
 * @param encryptionMethod - The encryption method to be used for hashing.
 * @param digest - The digest type to be used for hashing.
