...
const action = {
    ...
    perform: (request, { payload, settings }) => {
        ...
        if (Object.keys(utm_properties ?? {}).length || referrer) {
            properties.user_properties = merge_user_properties_1.mergeUserProperties(actions_core_1.omit(properties.user_properties ?? {}, ['utm_properties', 'referrer']), utm_1.convertUTMProperties(payload), referrer_1.convertReferrerProperty(payload));
        }
