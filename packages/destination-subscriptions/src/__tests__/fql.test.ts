...
test('traits "test" = true', () => {
  testFql('traits.test = true', {
    type: 'group',
    operator: 'and',
    children: [
      {
...
test('traits "test" = false', () => {
  testFql('traits.test = false', {
    type: 'group',
    operator: 'and',
    children: [
      {
...
test('type = "track" and (event = "Product Added" or event = "Order Completed")', () => {
  testFql('type = "track" and (event = "Product Added" or event = "Order Completed")', {
    type: 'group',
    operator: 'and',
    children: [
      {
...
test('event = "Product Added" and property "price" >= 100 and property "premium" = true', () => {
  testFql('event = "Product Added" and properties.price >= 100 and properties.premium = "true"', {
    type: 'group',
    operator: 'and',
    children: [
      {
...
test('event = "identify" and traits "logins" >= 10 and traits "plan" = "premium"', () => {
  testFql('event = "identify" and traits.logins >= 10 and traits.plan = "premium"', {
    type: 'group',
    operator: 'and',
    children: [
      {
...
test('(event = "identify" and trait "logins" >= 100) or (event = "Signed Up" and trait "age" >= 50)', () => {
  testFql('(event = "identify" and traits.logins >= 100) or (event = "Signed Up" and traits.age >= 50)', {
    type: 'group',
    operator: 'or',
    children: [
      {
