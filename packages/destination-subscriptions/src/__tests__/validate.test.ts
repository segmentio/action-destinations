...
test('event = "Page Viewed" and event property "name" = "Catalog"', () => {
  ...
  expect(validate(ast, { event: 'Page Viewed', properties: { name: 'Catalog' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed' })).toEqual(false)
  expect(validate(ast, { event: 'Page Viewed', properties: { name: 'Other' } })).toEqual(false)
})
...
test('event = "Page Viewed" and event property "name" = "Catalog" or "Home"', () => {
  ...
  expect(validate(ast, { event: 'Page Viewed', properties: { name: 'Catalog' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed', properties: { name: 'Home' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed', properties: { name: 'Other' } })).toEqual(false)
})
...
test('event = "Page Viewed" and event context "ip" = "1.1.1.1"', () => {
  ...
  expect(validate(ast, { event: 'Page Viewed', context: { ip: '1.1.1.1' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed' })).toEqual(false)
  expect(validate(ast, { event: 'Page Viewed', context: { ip: '8.8.8.8' } })).toEqual(false)
})
...
test('event = "Page Viewed" and event context "ip" = "1.1.1.1" or "2.2.2.2"', () => {
  ...
  expect(validate(ast, { event: 'Page Viewed', context: { ip: '1.1.1.1' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed', context: { ip: '2.2.2.2' } })).toEqual(false)
  expect(validate(ast, { event: 'Page Viewed' })).toEqual(false)
  expect(validate(ast, { event: 'Page Viewed', context: { ip: '8.8.8.8' } })).toEqual(false)
})
...
test('pull properties from `traits` object for "identify" and "group" events', () => {
  ...
  expect(validate(ast, { type: 'identify', traits: { name: 'Jane Hopper' } })).toEqual(true)
  expect(validate(ast, { type: 'group', traits: { name: 'Jane Hopper' } })).toEqual(true)
  expect(validate(ast, { event: 'Page Viewed' })).toEqual(false)
  expect(validate(ast, { type: 'identify', traits: { name: 'Demogorgon' } })).toEqual(false)
})
