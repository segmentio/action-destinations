...
export const destination = {
    ...
    settings: {
        ...
        disablePushTokenMaintenance: {
            ...
            default: true,
            required: false,
            description: 'By default, users who have already granted web push permission will sync their push token with the Braze backend automatically on new session to ensure deliverability. To disable this behavior, set this option to false'
        },
    ...
    initialize: async ({ settings }, dependencies) => {
        try {
            const { endpoint, api_key, sdkVersion, automaticallyDisplayMessages, versionSettings, subscriptions, ...expectedConfig } = settings;
