...
const action = {
    ...
    perform: (client, { payload }) => {
        ...
        payload.current_location?.key !== undefined &&
            user.setCustomLocationAttribute(payload.current_location.key, payload.current_location.latitude, payload.current_location.longitude);
        ...
        payload.email_subscribe !== undefined &&
            user.setEmailNotificationSubscriptionType(payload.email_subscribe);
        payload.email !== undefined && user.setEmail(payload.email);
        payload.first_name !== undefined && user.setFirstName(payload.first_name);
        payload.gender !== undefined && user.setGender(toBrazeGender(payload.gender));
        ...
        payload.push_subscribe !== undefined &&
            user.setPushNotificationSubscriptionType(payload.push_subscribe);
    }
};
