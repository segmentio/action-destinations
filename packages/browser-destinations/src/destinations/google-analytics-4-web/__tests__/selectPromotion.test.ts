...
describe('GoogleAnalytics4Web.selectPromotion', () => {
  test('Basic Event with Default Mappings', async () => {
    ...
    destination.actions.selectPromotion.perform = jest.fn(destination.actions.selectPromotion.perform)
    ...
    expect(destination.actions.selectPromotion.perform).toHaveBeenCalledWith(
      expect.anything(),
