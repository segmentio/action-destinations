...
const action: ActionDefinition<Settings, Payload> = {
  ...
  description: 'Record custom events in Test Warehouse',
  fields: {
    event: {
      label: 'Table Name',
    ...
    properties: {
      label: 'Columns',
      description: `Additional columns to write to Test Warehouse.`,
      type: 'object',
    ...
    type: {
      ...
      // but it's removed before being sent to Test Warehouse
      unsafe_hidden: true
    },
    receivedAt: {
      label: 'Received At',
