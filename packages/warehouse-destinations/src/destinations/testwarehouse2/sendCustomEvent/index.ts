...
const action: ActionDefinition<Settings, Payload> = {
  ...
  description: 'Record custom events in Test Warehouse 2',
  fields: {
    event: {
      label: 'Table Name',
    ...
    properties: {
      label: 'Columns',
      description: `Additional columns to write to Test Warehouse 2.`,
      type: 'object',
    ...
    type: {
      ...
      // but it's removed before being sent to the warehouse
      unsafe_hidden: true
    },
    receivedAt: {
      label: 'Received At',
