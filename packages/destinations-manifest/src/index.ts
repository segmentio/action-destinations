...
register('60ae8b97dcb6cc52d5d0d5ab', '@segment/analytics-browser-actions-google-ec-plugins')
...
// TEMPORARY bug-bash (Row 77, scratch): browser half of the hybrid destination. Never merge.
register('000000000000000000000001', '@segment/analytics-browser-actions-bug-bash-hybrid')
